...
public class ReItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
    ...
    private final RecyclerView.OnItemTouchListener mOnItemTouchListener
        ...
        public boolean onInterceptTouchEvent(@NonNull RecyclerView recyclerView, @NonNull MotionEvent motionEvent) {
            ...
            if (DEBUG) {
                Log.d(TAG, "intercept: x:" + motionEvent.getX() + ",y:" + motionEvent.getY() + ", " + motionEvent);
            }
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                if (mSelected == null) {
                    final RecoverAnimation animation = findAnimation(motionEvent);
                    if (animation != null) {
                ...
                // can select the item
                final int index = motionEvent.findPointerIndex(mActivePointerId);
                if (DEBUG) {
                    Log.d(TAG, "pointer index " + index);
                }
                if (index >= 0) {
                    checkSelectForSwipe(action, motionEvent, index);
                }
            }
        ...
        public void onTouchEvent(@NonNull RecyclerView recyclerView, @NonNull MotionEvent motionEvent) {
            ...
            if (DEBUG) {
                Log.d(TAG,
                        "on touch: x:" + mInitialTouchX + ",y:" + mInitialTouchY + ", :" + motionEvent);
            }
            ...
            if (activePointerIndex >= 0) {
                checkSelectForSwipe(action, motionEvent, activePointerIndex);
            }
            ...
            switch (action) {
                case MotionEvent.ACTION_MOVE: {
                    ...
                    if (activePointerIndex >= 0) {
                        ...
                        updateDxDy(motionEvent, mSelectedFlags, activePointerIndex);
                ...
                case MotionEvent.ACTION_POINTER_UP: {
                    ...
                    if (pointerId == mActivePointerId) {
                        ...
                        updateDxDy(motionEvent, mSelectedFlags, pointerIndex);
                    }
                    break;
                }
            }
    ...
    void select(RecyclerView.ViewHolder selected, int actionState) {
        ...
        if (mSelected != null) {
            ...
            if (prevSelected.itemView.getParent() != null) {
                ...
                final RecoverAnimation recoverAnimation = new RecoverAnimation(prevSelected, animationType,
                ...
                if (mCallback.getDefaultSwipeAnimationDuration() < 0) {
                    ...
                    recoverAnimation.setDuration(mCallback.getDefaultSwipeAnimationDuration());
                }
...
//            }
    ...
    public abstract static class Callback {
        ...
        private static final IReItemTouchUI sUICallback;
        ...
        static {
            if (Build.VERSION.SDK_INT >= 21) {
                sUICallback = new ReItemTouchUIImpl.Lollipop();
            } else if (Build.VERSION.SDK_INT >= 11) {
                sUICallback = new ReItemTouchUIImpl.Honeycomb();
            } else {
                sUICallback = new ReItemTouchUIImpl.Gingerbread();
            }
        }

        public static IReItemTouchUI getDefaultUIUtil() {
            return sUICallback;
        }
